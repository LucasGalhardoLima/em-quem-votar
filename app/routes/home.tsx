...
import { Search, ChevronDown, BookOpen, User, Scale, Gavel, LandPlot, Loader2, Sparkles, Mail } from "lucide-react";
                ...
                <Suspense 
                  fallback={
                    Array.from({ length: 3 }).map((_, i) => (
                      <div key={i} className="bg-gray-50 rounded-2xl p-8 animate-pulse h-48"></div>
                    ))
                  }
                >
